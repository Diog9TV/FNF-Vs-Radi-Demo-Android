...
function onCreate()
    makeLuaSprite('background', 'radi/back-3', 0, 0)

    makeLuaSprite('background-1', 'radi/back-4', -150, -100)
    ...
    makeLuaSprite('front', 'radi/Front3', 75, 75)
...
function onCreatePost()
    ...
    makeLuaSprite('aci', 'radi/Radi_UI/AcidHealthBar', 319, 48)
   ...
   setTextSize('judgementCounter', 20);
        ...
        if not downscroll then -- if upscroll
            ...
            setProperty("aci.y", screenHeight / -60 + 620)
